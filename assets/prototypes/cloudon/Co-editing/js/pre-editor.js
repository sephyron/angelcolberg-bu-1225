var editor = (function() {
	...
	var textOptions, optionsBox, boldButton, italicButton, quoteButton, urlButton, urlInput, hstyleButton, shareButton;
	...
	function bindElements() {
		...
		hstyleButton = textOptions.querySelector( '.hstyles' );
		hstyleButton.onmousedown = onHstyleClick;
		
		shareButton = textOptions.querySelector( '.share' );
		shareButton.onmousedown = onShareClick;
		
		copyButton = textOptions.querySelector( '.copy' );
		copyButton.onmousedown = onCopyClick;
	...
	function updateBubbleStates() {
		...
		if ( hasNode( currentNodeList, 'H') ) {
			hstyleButton.className = "hstyles active"
		} else {
			hstyleButton.className = "hstyles"
		}
		
		if ( hasNode( currentNodeList, 'SHARE') ) {
			shareButton.className = "share useicons active"
		} else {
			shareButton.className = "share useicons"
		}/**/
