$(function(){
    ...
    for (i=0; i<partners.length; i++) {
        $('.items').append('<div data-index="'+i+'" class="item-'+(i+1)+'" style="background: url(v7/images/item2/images/2-4_'+(i+1)+'.png) no-repeat"><div class="white"></div><div class="hover"></div><a href="#" class="company-link">'+partners[i][0]+'</a><a href="" class="contact-link"></a></div>');
    };
