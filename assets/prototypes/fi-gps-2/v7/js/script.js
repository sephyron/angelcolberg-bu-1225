$(function(){
    ...
    var partners = [
        ['MediaTrax, LLC', 500, 'adv', true, true, "mediatrax.com", "2977 McFarlane Rd #304, Miami, FL 33133,<br /> USA", 'MediaTrax, LLC is a leader in wholesale online marketing services. We provide digital marketing infrastructure and end-to-end solutions that enable the channel (digital agencies, newspapers, Yellow Pages and digital publishers) to be more efficient and profitable. The MediaTrax Platform offers solutions for each major building block of the digital marketing arena: Pre-sales, Presence, Traffic & Tracking. Individual services can be ordered “a la carte” and on a pay-as-you-go basis. One solution to fit every need. Whether your company needs a landing site for just one advertiser or a full search marketing strategy with customized performance tracking.'],
        ['Haystack Digital', 1000, 'web', true, true, "haystak.com", "1525 Hendry St. Fort Myers, Florida 3390,<br /> USA", 'A full service internet marketing firm that provides effective Search Engine Marketing, Social Media Marketing, Email Marketing, Mobile Marketing, Reputation Management, Marketing Strategy Consultation and more.'],
        ['SuperMedia, LLC', 2500, 'web', true, false, "supermedia.com", "330 Old Country Rd, Mineola, NY 11501,<br /> USA", "I've been managing AdWords accounts of different sizes for over 5 years. I work on a policy of continuous improvement where a large part of my time is spent in learning researching and developing. This is not only for AdWords but in all forms of online marketing. I think this is a must considering the speed of change in AdWords, Google and the internet in general."],
        ['Revena', 1000, 'adv', true, true, "reneva.lv", "A.Deglava 45, Riga,<br /> LV-1035,<br /> Latvia", 'Our company is founded on one principle - to be the best in the world at implementing high ROI online marketing campaigns, developing effective low cost web solutions, and providing quality customer care. Whether your prospects are searching on Google, reading reviews on yelp, chatting on Facebook, or browsing on their mobile, laptop or tablet, we can help you connect with them and turn them into paying customers.'],
        ['ReachLocal', 500, 'web', false, true, "reachlocal.com.au", "836 Wellington St, West Perth WA 6005,<br /> Australia", 'ReachLocal: Inc.’s (NASDAQ: RLOC) mission is to help small- and medium-sized enterprises (SMEs) acquire, maintain and retain customers via the Internet. ReachLocal offers a comprehensive suite of online marketing solutions, including search engine marketing (ReachSearch™), search engine optimisation (ReachSEO Plus), display advertising (ReachDisplay), retargeting advertising (ReachRetargeting), assisted live-chat technology (TotalLiveChat™) and online marketing analytics (TotalTrack®), each targeted to the SME market. ReachLocal delivers this suite of services to SMEs through a combination of its proprietary technology platform and its direct.'],
        ['Dex Media', 1000, 'web', false, true, "dexmedia.com", "2200 W Airfield Dr, Grapevine, TX&nbsp;76051,<br /> USA", "A Google AdWords partner since 2006, Dex Media™ is a marketing solutions leader trusted by approximately 580,000 local business clients nationwide. We’re committed to helping our clients create and grow their customer relationships by providing a customizable mix of marketing solutions. These include websites, print, mobile, social media and search engine marketing. Marketing Consultants across the U.S. are helping businesses like yours stand out from the crowd. Depending on where you are located, one of our Marketing Consultants will work with you to help you get more customers and meet your business goals."],
        ['BoomTown', 2500, 'adv', true, true, "boomtownig.com", "166 W Butler Dr, Drums, PA&nbsp;18222,<br /> USA", "Boomtown Internet Group is a full service Internet Marketing Company specializing in Pay-Per-Click Advertising, Search Engine Optimization Services, and Website Design and Development"],
        ['TopSpot Internet', 1000, 'web', true, true, "topspotims.com", "5120 Woodway Dr, Houston, TX&nbsp;77056,<br /> USA", "TopSpot Internet Marketing has been a Google AdWords partner in the USA since 10/1/2008. Since 2003, TopSpot Internet Marketing has been helping B2B/industrial companies plan, implement & measure their online marketing efforts. Most importantly, TopSpot understands that more internet traffic does not necessarily equal success. Although every company may measure their success differently, the goal for building an effective search engine marketing plan is it must have a positive impact on your business. We understand that companies budgets vary, yet a web presence is vital."],
        ['Jumpfly, Inc', 500, 'adv', true, true, "jumpfly.com", "2541 Technology Dr, Elgin, IL&nbsp;60124,<br /> USA", 'JumpFly professionally develops, implements, and manages Google AdWords, Bing Ads and Facebook PPC campaigns. We have been ranked the #1 PPC Company in the US by TopSEOs.com since 2008. We pride ourselves on our unmatched reputation of providing cutting edge knowledge and unmatched experience to maximize your PPC investment each month. We work month to month without contract and offer a money back guarantee. We are completely dedicated to customer satisfaction.'],
        ['Wahlstrom', 1000, 'adv', false, false, "wahlstrom.com", "800 Connecticut Ave, Norwalk, CT&nbsp;06854,<br /> USA", "Wahlstrom is a leader in performance based marketing solutions. Since 1954, Wahlstrom has delivered quality leads by connecting brands with ready to buy consumers by working at the crossroads of time and location. By combining creative passion, strategic and technological insight, a belief in the power of partnerships, and a love for great ideas, we help drive our clients’ business further by delivering measurable results."],
        ['blue onion', 2500, 'web', true, true, "digourideas.com", "940 Wadsworth Blvd, Lakewood, CO&nbsp;80214,<br /> USA", "Full Service Advertising Agency"],
        ['The EW Scripps', 1000, 'adv', true, true, "scripps.com", "312 Walnut St, Cincinnati, OH&nbsp;45202,<br /> USA", "We are a Preston based full service internet, website design, search engine optimisation (SEO) and digital marketing agency with a wealth of experience providing clients with world class web solutions."],
        ['Scorpion Design', 500, 'adv', true, false, "scorpiondesign.com", "28480 Avenue Stanford, Valencia, CA&nbsp;91355,<br /> USA", "Full service internet marketing company serving professionals across the country."],
        ['aimClear', 1000, 'adv', true, true, "aimclearblog.com", "9 W Superior St, Duluth, MN&nbsp;55802,<br /> USA", "aimClear is an integrated social, search, PR & display marketing agency."],
        ['The Zimmerman', 2500, 'adv', true, true, "zadv.com", "2200 W Commercial Blvd, Fort Lauderdale, FL&nbsp;33309,<br /> USA", "Zimmerman, an Omnicom Group company, is the leading national retail brand builder with more than 1100 associates and offices throughout the country."],
    ...
    $('.search-link').on('click', function(e){
        e.preventDefault();
        if ($('.two').hasClass('two_sidebar')) {
            $('.two').removeClass('two_sidebar');
        } else {
            $('.two').addClass('two_sidebar');
        }
    });
    ...
    $('.company-link, .profile-page').on('click', function(e){
            ...
            $wrap.fadeOut(350, function(){
                ...
                $items.stop().each(function(i){
                    if (result.indexOf(i)>=0) {
                        $(this).css('opacity', 0).show().delay(50 * index).fadeTo(225, 1);
                        index++;
                    }
                });
            });
...
//Main Checkbox
    ...
    $('.one .checkbox').click(function(){
        if (!$('.one .checkbox_checked').length) {
            ...
            $('.choose').animate({ marginTop: 0 }, 450, 'easeInOutQuart').find('.checked').fadeIn(450);
        ...
        if (!$(this).hasClass('checkbox_checked')) {
				...
				$(this).addClass('checkbox_checked');
				$(".button-both").removeClass('checkbox_checked');
            ...
            $(this).removeClass('checkbox_checked');
			$(".one .checkbox, .button-both").removeClass('checkbox_checked');
        };
        updateOne();
...
$('.one .button-both').click(function(){
        if (!$('.one .checkbox_checked').length) {
        ...
        if (!$(this).hasClass('checkbox_checked')) {
			$(".one .checkbox").addClass('checkbox_checked');
           $(this).addClass('checkbox_checked');
    ...
    $('.four .close, .search-again, .logo').on('click', function(e){
        ...
        if ($(this).is('.search-again') || $(this).is('.logo')) {
            $('.overlay').fadeOut(350);
    ...
    var bindInThree = function(){
        $('.three .six-link').on('click', function(e){
            ...
            $('.overlay').fadeIn(350);
            $('.six').animate({ top: '0%' }, 750, 'easeInOutQuart');
            return false;
        });
